...
public class RequestURL {
    ...
    //IP地址,端口号
    public static final String ip_port = "http://192.168.43.120:8080/api/";
    //IP地址，视频路径
    public static final String ip_video = "http://192.168.42.52:8080/video";
    //IP地址,图片路径
    public static final String ip_images = "http://192.168.43.120:8080/";
    //首页地址
